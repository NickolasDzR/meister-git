...
var cubage = main_order_form.querySelector("[name=cubage]");

main_order_form.addEventListener("submit", function (evt) {
  if (!name_company.value || !telephone_email.value || !point_send.value || !point_get.value || !load_weight.value || !cubage.value) {
    evt.preventDefault();
