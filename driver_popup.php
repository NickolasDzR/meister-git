...
$mail->Subject = 'Кого-то интересует вакансия "Водитель"';
$mail->Body    = 'Кто-то по имени - ' .$name_driver. '<br>' .'Просит перезвонить на номер - '  .$number_driver. '<br>'. 'Его интересует вакансия Водитель';
$mail->AltBody = '';
